...
class FcmRegistrationWorker(private val context: Context, params: WorkerParameters) : Worker(context, params) {
    ...
    override fun doWork(): Result {
        ...
        when (action) {
            ...
            ACTION_HIDE_NOTIFICATION -> {
                ...
                val recommendationId = inputData.getString(NotificationHelper.EXTRA_RECOMMENDATION_ID)
                val moostActionQualifier = inputData.getString(NotificationHelper.EXTRA_MOOST_ACTION_QUALIFIER)
    ...
    companion object {
        ...
        private fun makeHideNotificationIntent(
            ...
            return Intent(context, FcmRegistrationWorker::class.java)
